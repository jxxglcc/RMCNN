...
from utils.load_data import load_BCIC, dataloader_in_main
...
def main(args, train, val, test, train_y, val_y, test_y, sub, total_sub, validation):
    ...
    early_stopping = EarlyStopping(
        ...
        path_w   = args.weights_folder_path + 'Tensor_CSPNet' + '_checkpoint.pt', 
    ...
    for epoch in range(1, args.epochs+1):
        ...
        print('----#------#-----#-----#-----#-----#-----#-----')
        print('['+'Tensor_CSPNet'+': Sub No.{}/{}, Epoch {}/{}]:'.format(sub, total_sub, epoch, args.epochs))   
        start_t = time.time()
        for batch_idx, (batch_train, batch_train_y) in enumerate(train_loader):
            ...
            if batch_idx % args.log_interval == 0:
                ...
                torch.save(model.state_dict(), args.weights_folder_path + 'Tensor_CSPNet'+'_model.pth')
        ...
        if validation:
            ...
            pass
    print ('d_time:' + str(dtime_total/(args.train_batch_size*args.epochs)))  
    print ('t_time:' + str(ttime_total/args.epochs))
...
if __name__ == '__main__':
    ...
    for sub in range(args.start_No, args.end_No + 1):
        ...
        x_train_stack, x_valid_stack, x_test_stack, y_train, y_valid, y_test = BCIC_dataset.generate_training_valid_test_set_Holdout()
        ...
        print('Tensor_CSPNet' + ' Testing Loss.: {:4f} Acc: {:4f}'.format(loss, acc))
