...
def train(args, data_train, label_train, data_val, label_val, subject, fold=None):
    ...
    for epoch in range(1, args.max_epoch + 1):
        if fold:
            print('sub{} stage1 fold{} epoch{}'.format(subject, fold, epoch))
        else:
...
def test(args, data, label,  subject, fold=None):
    # set_up(args)
    seed_all(args.random_seed)
