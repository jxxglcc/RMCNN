...
class MLEngine:
    def __init__(self,data_path='',file_to_load='',subject_id=1,sessions=[1, 2],ntimes=1,kfold=2,m_filters=2,window_details={}):
    ...
    def experiment(self):
        ...
        '''for BCIC Dataset'''
        # eeg_data =LoadData.Loadbcic(self.subject_id, self.sessions, self.data_path)
        ...
        if 'BCI-Ⅳ-2A' in self.data_path:
            ...
            eeg_data =LoadData.Loadopenbmi(self.subject_id, self.sessions, self.data_path)
        ...
        print('*' * 10, '\n')
        return np.asarray(testing_accuracy), mean_testing_accuracy
